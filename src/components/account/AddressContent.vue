    ...
    <div>
        <div class="grid gap-8 lg:grid-cols-[260px_minmax(0,1fr)]">
            ...
            <section>
                <div class="space-y-3">
                    <div
                            v-if="!addressesStore.addresses.length"
                    ...
                    <button
                            ...
                            :class="
                            addressesStore.selectedAddressId === address.id
                                ? 'border-neutral-900'
                        ...
                        <div class="flex gap-3">
                            <span
                                    ...
                                    :class="
                                    addressesStore.selectedAddressId === address.id ? 'border-black' : 'border-neutral-300'">
                                <span
                                        v-if="addressesStore.selectedAddressId === address.id"
                ...
                <button
                        type="button"
                        class="mt-5 flex h-11 w-full cursor-pointer items-center
                        justify-center gap-2 border border-neutral-200 px-6 text-xs transition hover:border-black"
                        @click="openAddForm">
                    <Plus :size="15" />
                ...
                <template
                    ...
                    <div class="mt-7 grid gap-5 sm:grid-cols-2">
                        <div>
                            ...
                            <div class="border border-neutral-200 px-4 py-3 text-sm">
                    ...
                    <label class="mt-6 flex cursor-pointer items-center gap-3 text-xs text-neutral-500">
                        <input
                                type="checkbox"
                ...
                <template v-else>
                    <div class="flex items-center justify-between">
                        ...
                        <button
                                type="button"
                                aria-label="Закрыть"
                                class="flex h-8 w-8 cursor-pointer items-center justify-center text-neutral-400
